...
| Capability lifecycle | Planned `capability_record.v1`, `capability_registry_snapshot.v1`, `capability_deployment_receipt.v1` | Skill, MCP, tool, and TST worker-manual source must be selected from repo-managed capability snapshots, not provider-local install state. |
