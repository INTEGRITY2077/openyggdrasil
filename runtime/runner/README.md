...
- `Real UX Regression`: owns Phase 2 deterministic user-like accepted decision and correction/supersession scenarios before live-provider polish.
...
- `real_ux_regression_result.v1`: typed Phase 2 result for accepted decision UX, correction/supersession UX, support delivery, and source/provenance answer shortcut proof.
