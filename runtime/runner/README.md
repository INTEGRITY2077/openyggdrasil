...
- `Real UX Regression`: owns Phase 2 deterministic user-like accepted decision, correction/supersession, and boundary transition scenarios before live-provider polish.
...
- `real_ux_regression_result.v1`: typed Phase 2 result for accepted decision UX, correction/supersession UX, boundary transition UX, support delivery, and source/provenance answer shortcut proof.
