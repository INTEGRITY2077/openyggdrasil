...
from map_identity import build_episode_id, build_page_id, build_topic_id, normalize_key
...
from topic_episode_placement import validate_placement_verdict
...
def ensure_promotion_job_has_placement(job: Mapping[str, Any]) -> dict[str, Any]:
    from topic_episode_placement import ensure_promotion_job_has_placement as ensure
