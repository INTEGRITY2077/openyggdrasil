...
- `Real UX Regression`: owns Phase 2 deterministic user-like regression scenarios before live-provider polish.
...
- `real_ux_regression_result.v1`: typed Phase 2 result for accepted decision UX, support delivery, and source/provenance answer shortcut proof.
