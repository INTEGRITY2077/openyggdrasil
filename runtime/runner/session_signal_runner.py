...
def run_session_signal_entrypoint(
    ...
    *,
    ...
    result = {
        "schema_version": "session_signal_runner_entrypoint_result.v0",
        ...
        if integrity_result.get("admission_allowed")
        else ["provider_runtime_integrity"],
        "pending_steps": ["thin_worker_chain"] if accepted else [],
